...
const MOCK_RULES = [
  ...
  { name: "noreply@aws.amazon.com", folder: "team/aws", on: false },
];
...
export function MockRulesManager() {
  return (
    <div className="w-full rounded-xl border border-slate-200 dark:border-slate-800 shadow-xl dark:shadow-2xl overflow-hidden text-xs select-none bg-white dark:bg-slate-900">
      <div className="flex items-center gap-1.5 bg-slate-100 dark:bg-slate-950 px-3 py-2 border-b border-slate-200 dark:border-slate-800">
